...
public class Example_25 extends Application {

  @Override
  public void start(Stage primaryStage) {   

    // Create an Arc
    //                   Centered  at   radiusX  radiusY          Starting angle  Length of Arc
    //                                  How far out from center
    Arc arc1 = new Arc(  150, 100,      80,      80,            30,             35);
    arc1.setFill(Color.RED);
    arc1.setType(ArcType.ROUND); // Display format
