...
public class DataModelPieView3 extends AbstractDataView{

  public DataModelPieView3(DataModel dataModel){
  ...
  private void drawPieChartWins(Graphics g){
    ...
    percentage = getDataModel().getPercentSeriesWon();
    ...
    g.drawString("Percent of Series Won", 130, 15);
    ...
    g.drawString("Number World Series won:  " + getDataModel().getTotalSeriesWins(), 130, 75);
    g.drawString("Number World Series lost:  " + getDataModel().getTotalSeriesLoses(), 130, 95);
  }
