...
public class CreateTable{
  ...
  public CreateTable(){
    ...
    try{
      ...
      String url = "jdbc:mysql://localhost:3306/database33?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";

      //con = DriverManager.getConnection(url + "user=student33&password=Passw0rd");
      con = DriverManager.getConnection(url, "student33", "Passw0rd");
